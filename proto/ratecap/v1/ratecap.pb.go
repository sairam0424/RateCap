...
func (Priority) Descriptor() protoreflect.EnumDescriptor {
	return file_ratecap_v1_ratecap_proto_enumTypes[1].Descriptor()
}

func (Priority) Type() protoreflect.EnumType {
	return &file_ratecap_v1_ratecap_proto_enumTypes[1]
}
...
type CheckRateLimitRequest struct {
	...
	SkipReservations bool                   `protobuf:"varint,3,opt,name=skip_reservations,json=skipReservations,proto3" json:"skip_reservations,omitempty"`
	Priority         Priority               `protobuf:"varint,4,opt,name=priority,proto3,enum=ratecap.v1.Priority" json:"priority,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *CheckRateLimitRequest) GetSkipReservations() bool {
	if x != nil {
		return x.SkipReservations
	}
	return false
}

func (x *CheckRateLimitRequest) GetPriority() Priority {
	if x != nil {
		return x.Priority
	}
...
type SetDynamicLimitRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Tier          string                 `protobuf:"bytes,1,opt,name=tier,proto3" json:"tier,omitempty"`    // "rate_limiter" or "fleet_shedder"
	Value         int32                  `protobuf:"varint,2,opt,name=value,proto3" json:"value,omitempty"` // rate_limiter: new rate (requests/sec); fleet_shedder: new reserved_critical_pct (0-100)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SetDynamicLimitRequest) Reset() {
	*x = SetDynamicLimitRequest{}
	mi := &file_ratecap_v1_ratecap_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SetDynamicLimitRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetDynamicLimitRequest) ProtoMessage() {}

func (x *SetDynamicLimitRequest) ProtoReflect() protoreflect.Message {
	mi := &file_ratecap_v1_ratecap_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetDynamicLimitRequest.ProtoReflect.Descriptor instead.
func (*SetDynamicLimitRequest) Descriptor() ([]byte, []int) {
	return file_ratecap_v1_ratecap_proto_rawDescGZIP(), []int{5}
}

func (x *SetDynamicLimitRequest) GetTier() string {
	if x != nil {
		return x.Tier
	}
	return ""
...
func (x *SetDynamicLimitRequest) GetValue() int32 {
	if x != nil {
		return x.Value
	}
	return 0
...
type SetDynamicLimitResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *SetDynamicLimitResponse) Reset() {
	*x = SetDynamicLimitResponse{}
	mi := &file_ratecap_v1_ratecap_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SetDynamicLimitResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetDynamicLimitResponse) ProtoMessage() {}

func (x *SetDynamicLimitResponse) ProtoReflect() protoreflect.Message {
	mi := &file_ratecap_v1_ratecap_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetDynamicLimitResponse.ProtoReflect.Descriptor instead.
func (*SetDynamicLimitResponse) Descriptor() ([]byte, []int) {
	return file_ratecap_v1_ratecap_proto_rawDescGZIP(), []int{6}
}

func (x *SetDynamicLimitResponse) GetTier() string {
	if x != nil {
		return x.Tier
	}
	return ""
...
func (x *SetDynamicLimitResponse) GetPreviousValue() int32 {
	if x != nil {
...
func (x *SetDynamicLimitResponse) GetNewValue() int32 {
	if x != nil {
		return x.NewValue
	}
	return 0
...
const file_ratecap_v1_ratecap_proto_rawDesc = "" +
	...
	"\x1aReleaseConcurrencyResponse\"B\n" +
	"\x16SetDynamicLimitRequest\x12\x12\n" +
...
var file_ratecap_v1_ratecap_proto_goTypes = []any{
	...
	(*TokenReservation)(nil),           // 2: ratecap.v1.TokenReservation
	(*CheckRateLimitRequest)(nil),      // 3: ratecap.v1.CheckRateLimitRequest
	(*CheckRateLimitResponse)(nil),     // 4: ratecap.v1.CheckRateLimitResponse
	(*ReleaseConcurrencyRequest)(nil),  // 5: ratecap.v1.ReleaseConcurrencyRequest
